...
public class QueryExamplesGeneral
{
     ...
     */
    public QueryExamplesGeneral() throws URISyntaxException
    {
        super();
        ...
        session = Session.newSession(new URI(connectionURL), username, pw, ConnectionMode.PROJECT_MODE, contextName, productName);
